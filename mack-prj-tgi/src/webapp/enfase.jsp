...
<body>
	...
	<div class="bordaBox">
		...
		<div class="conteudo">
			...
			<br /> <br /> <br /> <br />
			<h1>Sistema Administrativo Enfases</h1>


			<%
				if (!(new EnfaseDao().getListaEnfases().equals(null))) {
			%>
			...
			<table border="1" width="50%">
				<tr style="background-color: ;">
					...
					<td>Codigo do Coordenador</td>
				</tr>
				<%
					List<Enfase> enfases = new EnfaseDao().getListaEnfases();
				...
				<tr style="cursor: default"
					...
					<td><%=enfase.getIdCodEnfase()%></td>
					<td><%=enfase.getNomeFase()%></td>
					<td><%=enfase.getCoordenadorFase()%></td>
			...
			<!-- FIM DA TABELA DE EXIBIÇÃO DOS Enfases CADASTRADaS -->

			<%
				} else {
			%>
			<h2>Não existe enfase Cadastrada</h2>
			<%
				}
			%>
